...
'water': {
    ...
    'tags':{
        ...
        drawing_kwargs = {
            'background': {'fc': '#2B2821', 'ec': '#E3CFB4', 'zorder': -1},
            'perimeter': {'fc': '#2B2821', 'ec': '#E3CFB4', 'lw': 4, 'zorder': 0},
            'green': {'fc': '#3E6958', 'ec': '#E0C872', 'lw': 0.5, 'zorder': 1},
            'water': {'fc': '#243D5C', 'ec': '#5C8B93','hatch': '...', 'hatch_c': '#5C8B93', 'lw': 0, 'zorder': 1},
            'streets': {'fc': '#B03A48', 'ec': '#2B2821', 'lw': 1, 'zorder': 16},
            'building': {'fc': '#624C3C', 'ec': '#2B2821', 'lw': 0.5, 'zorder': 15},
            'forest': {'fc': '#3E6958', 'ec': '#E0C872', 'lw': 0.5, 'zorder': 1},
            'agriculture': {'fc': '#624C3C', 'ec': '#D9AC8B', 'lw': 0.5, 'zorder': 1},
            'developingLand': {'fc': '#2B2821', 'ec': '#E3CFB4', 'lw': 0.5, 'zorder': 8},
            'sportstuff': {'fc': '#3E6958', 'ec': '#E0C872', 'lw': 0.5, 'zorder': 8},
            'gleisbett': {'fc': '#2B2821', 'ec': '#E3CFB4', 'lw': 0.5, 'zorder': 7},
            'cemeterystuff': {'fc': '#2B2821', 'ec': '#E3CFB4', 'lw': 0.5, 'zorder': 14},
            'place': {'fc': '#2B2821', 'ec': '#E3CFB4', 'lw': 0.1, 'zorder': 6},
            'man_made': {'fc': '#2B2821', 'ec': '#E3CFB4', 'lw': 2, 'zorder': 16},
            'garden': {'fc': '#3E6958', 'ec': '#E0C872', 'lw': 1, 'zorder': 1},
            'railway': {'fc': '#B03A48', 'ec': '#2B2821', 'lw': 0.1, 'zorder': 12},
            'parkplatz': {'fc': '#B03A48', 'ec': '#2B2821', 'lw': 0.5, 'zorder': 14},
            'highway': {'fc': '#B03A48', 'ec': '#2B2821', 'lw': 0.5, 'zorder': 17},
            'motorway': {'fc': '#B03A48', 'ec': '#2B2821', 'lw': 0.1, 'zorder': 17},
            'primary': {'fc': '#B03A48', 'ec': '#2B2821', 'lw': 0.1, 'zorder': 17},
            'service': {'fc': '#B03A48', 'ec': '#2B2821', 'lw': 0.1, 'zorder': 17},
            'trunk': {'fc': '#B03A48', 'ec': '#2B2821', 'lw': 0.1, 'zorder': 17},
            'secondary': {'fc': '#B03A48', 'ec': '#2B2821', 'lw': 0.1, 'zorder': 17},
            'tertiary': {'fc': '#B03A48', 'ec': '#2B2821', 'lw': 0.1, 'zorder': 17},
            'residential': {'fc': '#B03A48', 'ec': '#2B2821', 'lw': 0.1, 'zorder': 17},
            'living_street': {'fc': '#B03A48', 'ec': '#2B2821', 'lw': 0.1, 'zorder': 17},
            'pedestrian': {'fc': '#B03A48', 'ec': '#2B2821', 'lw': 0.1, 'zorder': 17},
            'footway': {'fc': '#B03A48', 'ec': '#2B2821', 'lw': 0.1, 'zorder': 17},
            'sideway': {'fc': '#B03A48', 'ec': '#2B2821', 'lw': 0.1, 'zorder': 17},
            'track': {'fc': '#B03A48', 'ec': '#2B2821', 'lw': 0.1, 'zorder': 17},
            'bridleway': {'fc': '#B03A48', 'ec': '#2B2821', 'lw': 0.1, 'zorder': 17},
            'cycleway': {'fc': '#B03A48', 'ec': '#2B2821', 'lw': 0.1, 'zorder': 17},
            'path': {'fc': '#B03A48', 'ec': '#2B2821', 'lw': 0.1, 'zorder': 17},
            'coastline': {'fc': '#243D5C', 'ec': '#5C8B93','hatch': '...', 'hatch_c': '#5C8B93', 'lw': 0, 'zorder': 2}
        },
