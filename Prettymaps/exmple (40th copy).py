...
'water': {
    ...
    'tags':{
        ...
        drawing_kwargs = {
            'background': {'fc': '#622E4C', 'ec': '#622E4C', 'zorder': -1},
            'perimeter': {'fc': '#622E4C', 'ec': '#622E4C', 'lw': 4, 'zorder': 0},
            'green': {'fc': '#7550E8', 'ec': '#608FCF', 'lw': 0.5, 'zorder': 1},
            'water': {'fc': '#608FCF', 'ec': '#8BE5FF','hatch': '...', 'hatch_c': '#8BE5FF', 'lw': 0, 'zorder': 1},
            'streets': {'fc': '#8BE5FF', 'ec': '#622E4C', 'lw': 1, 'zorder': 16},
            'building': {'fc': '#7550E8', 'ec': '#608FCF', 'lw': 0.5, 'zorder': 15},
            'forest': {'fc': '#608FCF', 'ec': '#7550E8', 'lw': 0.5, 'zorder': 1},
            'agriculture': {'fc': '#608FCF', 'ec': '#7550E8', 'lw': 0.5, 'zorder': 1},
            'developingLand': {'fc': '#608FCF', 'ec': '#7550E8', 'lw': 0.5, 'zorder': 8},
            'sportstuff': {'fc': '#608FCF', 'ec': '#7550E8', 'lw': 0.5, 'zorder': 8},
            'gleisbett': {'fc': '#608FCF', 'ec': '#7550E8', 'lw': 0.5, 'zorder': 7},
            'cemeterystuff': {'fc': '#608FCF', 'ec': '#7550E8', 'lw': 0.5, 'zorder': 14},
            'place': {'fc': '#608FCF', 'ec': '#7550E8', 'lw': 0.1, 'zorder': 6},
            'man_made': {'fc': '#608FCF', 'ec': '#7550E8', 'lw': 2, 'zorder': 16},
            'garden': {'fc': '#608FCF', 'ec': '#7550E8', 'lw': 1, 'zorder': 1},
            'railway': {'fc': '#8BE5FF', 'ec': '#7550E8', 'lw': 0.1, 'zorder': 12},
            'parkplatz': {'fc': '#608FCF', 'ec': '#8BE5FF', 'lw': 0.5, 'zorder': 14},
            'highway': {'fc': '#8BE5FF', 'ec': '#622E4C', 'lw': 0.5, 'zorder': 17},
            'motorway': {'fc': '#8BE5FF', 'ec': '#622E4C', 'lw': 0.1, 'zorder': 17},
            'primary': {'fc': '#8BE5FF', 'ec': '#622E4C', 'lw': 0.1, 'zorder': 17},
            'service': {'fc': '#8BE5FF', 'ec': '#622E4C', 'lw': 0.1, 'zorder': 17},
            'trunk': {'fc': '#8BE5FF', 'ec': '#622E4C', 'lw': 0.1, 'zorder': 17},
            'secondary': {'fc': '#8BE5FF', 'ec': '#622E4C', 'lw': 0.1, 'zorder': 17},
            'tertiary': {'fc': '#8BE5FF', 'ec': '#622E4C', 'lw': 0.1, 'zorder': 17},
            'residential': {'fc': '#8BE5FF', 'ec': '#622E4C', 'lw': 0.1, 'zorder': 17},
            'living_street': {'fc': '#8BE5FF', 'ec': '#622E4C', 'lw': 0.1, 'zorder': 17},
            'pedestrian': {'fc': '#8BE5FF', 'ec': '#622E4C', 'lw': 0.1, 'zorder': 17},
            'footway': {'fc': '#8BE5FF', 'ec': '#622E4C', 'lw': 0.1, 'zorder': 17},
            'sideway': {'fc': '#8BE5FF', 'ec': '#622E4C', 'lw': 0.1, 'zorder': 17},
            'track': {'fc': '#8BE5FF', 'ec': '#622E4C', 'lw': 0.1, 'zorder': 17},
            'bridleway': {'fc': '#8BE5FF', 'ec': '#622E4C', 'lw': 0.1, 'zorder': 17},
            'cycleway': {'fc': '#8BE5FF', 'ec': '#622E4C', 'lw': 0.1, 'zorder': 17},
            'path': {'fc': '#8BE5FF', 'ec': '#622E4C', 'lw': 0.1, 'zorder': 17},
