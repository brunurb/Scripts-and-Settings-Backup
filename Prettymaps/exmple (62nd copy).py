...
'water': {
    ...
    'tags':{
        ...
        drawing_kwargs = {
            'background': {'fc': '#000000', 'ec': '#FFFFFF', 'zorder': -1},
            'perimeter': {'fc': '#000000', 'ec': '#FFFFFF', 'lw': 4, 'zorder': 0},
            'green': {'fc': '#676767', 'ec': '#FFFFFF', 'lw': 0.5, 'zorder': 1},
            'water': {'fc': '#000000', 'ec': '#FFFFFF','hatch': '...', 'hatch_c': '#FFFFFF', 'lw': 0, 'zorder': 1},
            'streets': {'fc': '#FFFFFF', 'ec': '#000000', 'lw': 1, 'zorder': 16},
            'building': {'fc': '#B6B6B6', 'ec': '#000000', 'lw': 0.5, 'zorder': 15},
            'forest': {'fc': '#B6B6B6', 'ec': '#FFFFFF', 'lw': 0.5, 'zorder': 1},
            'agriculture': {'fc': '#B6B6B6', 'ec': '#FFFFFF', 'lw': 0.5, 'zorder': 1},
            'developingLand': {'fc': '#B6B6B6', 'ec': '#FFFFFF', 'lw': 0.5, 'zorder': 8},
            'sportstuff': {'fc': '#676767', 'ec': '#FFFFFF', 'lw': 0.5, 'zorder': 8},
            'gleisbett': {'fc': '#676767', 'ec': '#FFFFFF', 'lw': 0.5, 'zorder': 7},
            'cemeterystuff': {'fc': '#676767', 'ec': '#FFFFFF', 'lw': 0.5, 'zorder': 14},
            'place': {'fc': '#676767', 'ec': '#FFFFFF', 'lw': 0.1, 'zorder': 6},
            'man_made': {'fc': '#676767', 'ec': '#FFFFFF', 'lw': 2, 'zorder': 19},
            'garden': {'fc': '#676767', 'ec': '#FFFFFF', 'lw': 1, 'zorder': 1},
            'railway': {'fc': '#FFFFFF', 'ec': '#000000', 'lw': 0.1, 'zorder': 12},
            'parkplatz': {'fc': '#FFFFFF', 'ec': '#000000', 'lw': 0.5, 'zorder': 14},
            'highway': {'fc': '#FFFFFF', 'ec': '#000000', 'lw': 0.5, 'zorder': 17},
            'motorway': {'fc': '#FFFFFF', 'ec': '#000000', 'lw': 0.1, 'zorder': 17},
            'primary': {'fc': '#FFFFFF', 'ec': '#000000', 'lw': 0.1, 'zorder': 16},
            'service': {'fc': '#FFFFFF', 'ec': '#000000', 'lw': 0.1, 'zorder': 16},
            'trunk': {'fc': '#FFFFFF', 'ec': '#000000', 'lw': 0.1, 'zorder': 16},
            'secondary': {'fc': '#FFFFFF', 'ec': '#000000', 'lw': 0.1, 'zorder': 16},
            'tertiary': {'fc': '#FFFFFF', 'ec': '#000000', 'lw': 0.1, 'zorder': 16},
            'residential': {'fc': '#FFFFFF', 'ec': '#000000', 'lw': 0.1, 'zorder': 17},
            'living_street': {'fc': '#FFFFFF', 'ec': '#000000', 'lw': 0.1, 'zorder': 17},
            'pedestrian': {'fc': '#FFFFFF', 'ec': '#000000', 'lw': 0.1, 'zorder': 17},
            'footway': {'fc': '#FFFFFF', 'ec': '#000000', 'lw': 0.1, 'zorder': 17},
            'sideway': {'fc': '#FFFFFF', 'ec': '#000000', 'lw': 0.1, 'zorder': 17},
            'track': {'fc': '#FFFFFF', 'ec': '#000000', 'lw': 0.1, 'zorder': 17},
            'bridleway': {'fc': '#FFFFFF', 'ec': '#000000', 'lw': 0.1, 'zorder': 17},
            'cycleway': {'fc': '#FFFFFF', 'ec': '#000000', 'lw': 0.1, 'zorder': 17},
            'path': {'fc': '#FFFFFF', 'ec': '#000000', 'lw': 0.1, 'zorder': 17},
            'coastline': {'fc': '#000000', 'ec': '#FFFFFF','hatch': '...', 'hatch_c': '#FFFFFF', 'lw': 0, 'zorder': 2}
        },
