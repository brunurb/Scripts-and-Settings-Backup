...
layers = plot(
    ...
    layers = {
        ...
        drawing_kwargs = {
            'background': {'fc': '#f0f0f0', 'ec': '#0a0100', 'zorder': -1},
            'perimeter': {'fc': '#b3adae', 'ec': '#0a0100', 'lw': 4, 'zorder': 0},
            'green': {'fc': '#f0f0f0', 'ec': '#00520a', 'lw': 0.5, 'zorder': 1},
            'water': {'fc': '#f0f0f0', 'ec': '#0a0100', 'lw': 0, 'zorder': 9},
            'streets': {'fc': '#F1E6D0', 'ec': '#2F3737', 'lw': 1.5, 'zorder': 12},
            'building': {'palette': ['#595959', '#404040', '#303030'], 'ec': '#0a0100', 'lw': 0.1, 'zorder': 15},
            'railway': {'fc': '#F1E6D0', 'ec': '#FF0000', 'lw': 0, 'zorder': 12},
            'forest': {'fc': '#f0f0f0', 'ec': '#00660c', 'lw': 0, 'hatch': '//////', 'zorder': 1},
            'agriculture': {'fc': '#f0f0f0', 'ec': '#00660c', 'lw': 0, 'hatch': '\\\\\\\\\\\\', 'zorder': 1},
            'developingLand': {'fc': '#f0f0f0', 'ec': '#00660c', 'lw': 0, 'hatch': '//////', 'zorder': 8},
            'sportstuff': {'fc': '#f0f0f0', 'ec': '#ffffff', 'lw': 0.3, 'hatch': '//////', 'zorder': 8},
            'parkplatz': {'fc': '#f0f0f0', 'ec': '#ffffff', 'lw': 0.1, 'zorder': 3},
            'gleisbett': {'fc': '#7d797a', 'ec': '#32512b', 'lw': 0.1, 'zorder': 7},
            'cemeterystuff': {'fc': '#f0f0f0', 'ec': '#00660c', 'hatch': '\\\\\\\\\\\\', 'lw': 0, 'zorder': 14},
            'highway': {'fc': '#f0f0f0', 'ec': '#00660c', 'hatch': '//////', 'lw': 0, 'zorder': 10},
            'place': {'fc': '#f0f0f0', 'ec': '#ffffff', 'lw': 0, 'zorder': 6},
            'man_made': {'fc': '#b52812', 'ec': '#ffffff', 'lw': 0, 'zorder': 16},
            'garden': {'fc': '#f0f0f0', 'ec': '#8ab58a', 'lw': 1, 'hatch': '\\\\\\\\\\\\', 'zorder': 1},
