...
layers = plot(
    ...
    layers = {
        ...
        drawing_kwargs = {
            ...
            'forest': {'fc': '#f0f0f0', 'ec': '#00660c', 'lw': 0.5, 'zorder': 1},
            'agriculture': {'fc': '#f0f0f0', 'ec': '#00660c', 'lw': 0.5, 'zorder': 1},
            'developingLand': {'fc': '#f0f0f0', 'ec': '#00660c', 'lw': 0.5, 'zorder': 8},
            'sportstuff': {'fc': '#f0f0f0', 'ec': '#ffffff', 'lw': 0.5, 'zorder': 8},
            'parkplatz': {'fc': '#f0f0f0', 'ec': '#ffffff', 'lw': 0.5, 'zorder': 3},
            'gleisbett': {'fc': '#7d797a', 'ec': '#32512b', 'lw': 0.5, 'zorder': 7},
            'cemeterystuff': {'fc': '#f0f0f0', 'ec': '#00660c', 'lw': 0.5, 'zorder': 14},
            'highway': {'fc': '#f0f0f0', 'ec': '#00660c', 'lw': 0.5, 'zorder': 10},
            'place': {'fc': '#f0f0f0', 'ec': '#ffffff', 'lw': 0.1, 'zorder': 6},
            'man_made': {'fc': '#b52812', 'ec': '#ffffff', 'lw': 0, 'zorder': 16},
            'garden': {'fc': '#f0f0f0', 'ec': '#8ab58a', 'lw': 1, 'zorder': 1},
