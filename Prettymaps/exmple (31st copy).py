...
'water': {
    ...
    'tags':{
        ...
        drawing_kwargs = {
            'background': {'fc': '#1D2938', 'ec': '#13B37E', 'zorder': -1},
            'perimeter': {'fc': '#1D2938', 'ec': '#13B37E', 'lw': 4, 'zorder': 0},
            'green': {'fc': '#2A616E', 'ec': '#13B37E', 'lw': 0.5, 'zorder': 1},
            'water': {'fc': '#1D2938', 'ec': '#13B37E','hatch': '...', 'hatch_c': '#13B37E', 'lw': 0, 'zorder': 1},
            'streets': {'fc': '#42143e', 'ec': '#42143e', 'lw': 1, 'zorder': 16},
            'building': {'fc': '#2A616E', 'ec': '#13B37E', 'lw': 0.5, 'zorder': 15},
            'forest': {'fc': '#2A616E', 'ec': '#13B37E', 'lw': 0.5, 'zorder': 1},
            'agriculture': {'fc': '#2A616E', 'ec': '#13B37E', 'lw': 0.5, 'zorder': 1},
            'developingLand': {'fc': '#2A616E', 'ec': '#13B37E', 'lw': 0.5, 'zorder': 8},
            'sportstuff': {'fc': '#1D2938', 'ec': '#13B37E', 'lw': 0.5, 'zorder': 8},
            'parkplatz': {'fc': '#1D2938', 'ec': '#13B37E', 'lw': 0.5, 'zorder': 3},
            'gleisbett': {'fc': '#1D2938', 'ec': '#13B37E', 'lw': 0.5, 'zorder': 7},
            'cemeterystuff': {'fc': '#1D2938', 'ec': '#13B37E', 'lw': 0.5, 'zorder': 14},
            'place': {'fc': '#2A616E', 'ec': '#13B37E', 'lw': 0.1, 'zorder': 6},
            'man_made': {'fc': '#2A616E', 'ec': '#13B37E', 'lw': 2, 'zorder': 16},
            'garden': {'fc': '#2A616E', 'ec': '#13B37E', 'lw': 1, 'zorder': 1},
            'railway': {'fc': '#1ebab2', 'ec': '#df9ff5', 'lw': 0.1, 'zorder': 12},
            'parkplatz': {'fc': '#2A616E', 'ec': '#df9ff5', 'lw': 0.5, 'zorder': 3},
            'highway': {'fc': '#8bba1e', 'ec': '#e359ff', 'lw': 0.5, 'zorder': 17},
            'motorway': {'fc': '#ff36fc', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'primary': {'fc': '#e5ff00', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'service': {'fc': '#ff1cfb', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'trunk': {'fc': '#C00050', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'secondary': {'fc': '#FF2636', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'tertiary': {'fc': '#4064af', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'residential': {'fc': '#73ff00', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'living_street': {'fc': '#7AFF01', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'pedestrian': {'fc': '#2A616E', 'ec': '#FFFD01', 'lw': 0.1, 'zorder': 17},
            'footway': {'fc': '#2A616E', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'sideway': {'fc': '#0020FF', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'track': {'fc': '#FF7C00', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'bridleway': {'fc': '#FA00FF', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'cycleway': {'fc': '#56F373', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'path': {'fc': '#ffd500', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'coastline': {'fc': '#1D2938', 'ec': '#13B37E','hatch': '...', 'hatch_c': '#13B37E', 'lw': 0, 'zorder': 2}
        },
...
ax.text(
    ...
    fontsize=60,
    color='white',
    bbox=dict(fc='#1D2938', ec='white', boxstyle='square,pad=0.5'),
