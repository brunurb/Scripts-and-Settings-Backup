...
layers = plot(
    ...
    layers = {
        ...
        drawing_kwargs = {
            ...
            'green': {'palette': ['#855C75', '#D9AF6B', '#AF6458', '#736F4C', '#526A83', '#625377', '#68855C', '#9C9C5E', '#A06177', '#8C785D', '#467378', '#7C7C7C'], 'lw': 1, 'zorder': 1},
            'water': {'fc': '#79a5ec', 'ec': '#94c6ee', 'lw': 0, 'zorder': 9},
            'streets': {'fc': '#f2d8bf', 'lw': 0, 'zorder': 4},
            'building': {'palette': ['#855C75', '#D9AF6B', '#AF6458', '#736F4C', '#526A83', '#625377', '#68855C', '#9C9C5E', '#A06177', '#8C785D', '#467378', '#7C7C7C'], 'lw': 0.1, 'zorder': 9},
            'railway': {'fc': '#a2c2db', 'ec': '#FF0000', 'alpha': 1, 'lw': 0, 'zorder': 8},
            'forest': {'palette': ['#855C75', '#D9AF6B', '#AF6458', '#736F4C', '#526A83', '#625377', '#68855C', '#9C9C5E', '#A06177', '#8C785D', '#467378', '#7C7C7C'], 'lw': 0, 'zorder': 1},
            'agriculture': {'palette': ['#855C75', '#D9AF6B', '#AF6458', '#736F4C', '#526A83', '#625377', '#68855C', '#9C9C5E', '#A06177', '#8C785D', '#467378', '#7C7C7C'], 'lw': 0, 'zorder': 1},
            'developingLand': {'palette': ['#855C75', '#D9AF6B', '#AF6458', '#736F4C', '#526A83', '#625377', '#68855C', '#9C9C5E', '#A06177', '#8C785D', '#467378', '#7C7C7C'], 'lw': 0, 'zorder': 8},
            'sportstuff': {'palette': ['#855C75', '#D9AF6B', '#AF6458', '#736F4C', '#526A83', '#625377', '#68855C', '#9C9C5E', '#A06177', '#8C785D', '#467378', '#7C7C7C'], 'lw': 0.3, 'zorder': 8},
            'parkplatz': {'palette': ['#855C75', '#D9AF6B', '#AF6458', '#736F4C', '#526A83', '#625377', '#68855C', '#9C9C5E', '#A06177', '#8C785D', '#467378', '#7C7C7C'], 'lw': 0.1, 'zorder': 3},
            'gleisbett': {'palette': ['#855C75', '#D9AF6B', '#AF6458', '#736F4C', '#526A83', '#625377', '#68855C', '#9C9C5E', '#A06177', '#8C785D', '#467378', '#7C7C7C'], 'lw': 0, 'zorder': 7},
            'cemeterystuff': {'palette': ['#855C75', '#D9AF6B', '#AF6458', '#736F4C', '#526A83', '#625377', '#68855C', '#9C9C5E', '#A06177', '#8C785D', '#467378', '#7C7C7C'], 'lw': 0, 'zorder': 9},
            'highway': {'fc': '#46693b', 'ec': '#ffffff', 'lw': 0, 'zorder': 11},
            'place': {'palette': ['#855C75', '#D9AF6B', '#AF6458', '#736F4C', '#526A83', '#625377', '#68855C', '#9C9C5E', '#A06177', '#8C785D', '#467378', '#7C7C7C'], 'lw': 0, 'zorder': 6},
