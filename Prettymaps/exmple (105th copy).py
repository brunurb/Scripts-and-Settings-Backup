...
layers = plot(
    ...
    layers = {
            ...
            'highway': {'tags': {'highway': ['raceway']},'circle': doCircle, 'dilate': dilate},
        },
        drawing_kwargs = {
            'background': {'fc': '#ffffff', 'ec': '#95D5C1', 'zorder': -1},
            'perimeter': {'fc': '#ffe8c4', 'ec': '#383838', 'lw': 3, 'zorder': 0},
            'green': {'fc': '#AABD8C', 'ec': '#2F3737', 'lw': 0, 'zorder': 1},
            'water': {'fc': '#7DC1B5', 'lw': 0, 'zorder': 3},
            'streets': {'fc': '#C64C53', 'lw': 0, 'zorder': 4},
            'building': {'palette': ['#E06553', '#E88F69'], 'ec': '#D53E4F', 'lw': 0, 'zorder': 3},
            'railway': {'fc': '#a8a8a8', 'ec': '#FF0000', 'alpha': 1, 'lw': 0, 'zorder': 3},
            'forest': {'fc': '#8ED184', 'ec': '#ABDDA4', 'lw': 0, 'zorder': 1},
            'agriculture': {'fc': '#ABDDA4', 'ec': '#ABDDA4', 'lw': 0, 'zorder': 1},
            'developingLand': {'fc': '#898878', 'ec': '#2F3737', 'lw': 0, 'zorder': 1},
            'sportstuff': {'fc': '#66A457', 'ec': '#32512b', 'lw': 0.3, 'zorder': 1},
            'parkplatz': {'fc': '#FFC5A1', 'ec': '#32512b', 'lw': 0, 'zorder': 1},
            'gleisbett': {'fc': '#ebdbe8', 'ec': '#32512b', 'lw': 0, 'zorder': 1},
            'cemeterystuff': {'fc': '#7BAE82', 'ec': '#2F3737', 'lw': 0, 'zorder': 1},
            'highway': {'fc': '#000000', 'ec': '#ffffff', 'lw': 2, 'zorder': 1},
