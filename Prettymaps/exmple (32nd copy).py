...
'water': {
    ...
    'tags':{
        ...
        drawing_kwargs = {
            ...
            'man_made': {'fc': '#1d2938', 'ec': '#13B37E', 'lw': 2, 'zorder': 16},
            'garden': {'fc': '#2A616E', 'ec': '#13B37E', 'lw': 1, 'zorder': 1},
            'railway': {'fc': '#07EF5C', 'ec': '#df9ff5', 'lw': 0.1, 'zorder': 12},
            'parkplatz': {'fc': '#1c2837', 'ec': '#3e597a', 'lw': 0.5, 'zorder': 14},
            'highway': {'fc': '#07EF5C', 'ec': '#e359ff', 'lw': 0.5, 'zorder': 17},
            'motorway': {'fc': '#07EF5C', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'primary': {'fc': '#07EF5C', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'service': {'fc': '#07EF5C', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'trunk': {'fc': '#07EF5C', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'secondary': {'fc': '#07EF5C', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'tertiary': {'fc': '#07EF5C', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'residential': {'fc': '#07EF5C', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'living_street': {'fc': '#07EF5C', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'pedestrian': {'fc': '#153137', 'ec': '#FFFD01', 'lw': 0.1, 'zorder': 17},
            'footway': {'fc': '#07EF5C', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'sideway': {'fc': '#07EF5C', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'track': {'fc': '#07EF5C', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'bridleway': {'fc': '#07EF5C', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'cycleway': {'fc': '#07EF5C', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
            'path': {'fc': '#07EF5C', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
