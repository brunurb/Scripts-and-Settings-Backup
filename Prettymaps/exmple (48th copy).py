...
'water': {
    ...
    'tags':{
        ...
        drawing_kwargs = {
            'background': {'fc': '#F6EBD1', 'ec': '#F6EBD1', 'zorder': -1},
            'perimeter': {'fc': '#F6EBD1', 'ec': '#F6EBD1', 'lw': 4, 'zorder': 0},
            'green': {'fc': '#B4D5A8', 'ec': '#B4D5A8', 'lw': 0.5, 'zorder': 1},
            'water': {'fc': '#7DC1A8', 'ec': '#B4D5A8','hatch': '...', 'hatch_c': '#B4D5A8', 'lw': 0, 'zorder': 1},
            'streets': {'fc': '#C64C53', 'ec': '#674024', 'lw': 1, 'zorder': 16},
            'building': {'fc': '#F6EBD1', 'ec': '#674024', 'lw': 0.5, 'zorder': 15},
            'forest': {'fc': '#B4D5A8', 'ec': '#B4D5A8', 'lw': 0.5, 'zorder': 1},
            'agriculture': {'fc': '#B4D5A8', 'ec': '#B4D5A8', 'lw': 0.5, 'zorder': 1},
            'developingLand': {'fc': '#B4D5A8', 'ec': '#B4D5A8', 'lw': 0.5, 'zorder': 8},
            'sportstuff': {'fc': '#B4D5A8', 'ec': '#B4D5A8', 'lw': 0.5, 'zorder': 8},
            'gleisbett': {'fc': '#674024', 'ec': '#F6EBD1', 'lw': 0.5, 'zorder': 7},
            'cemeterystuff': {'fc': '#674024', 'ec': '#F6EBD1', 'lw': 0.5, 'zorder': 14},
            'place': {'fc': '#674024', 'ec': '#F6EBD1', 'lw': 0.1, 'zorder': 6},
            'man_made': {'fc': '#C64C53', 'ec': '#674024', 'lw': 2, 'zorder': 18},
            'garden': {'fc': '#B4D5A8', 'ec': '#B4D5A8', 'lw': 1, 'zorder': 1},
            'railway': {'fc': '#C64C53', 'ec': '#674024', 'lw': 0.1, 'zorder': 12},
            'parkplatz': {'fc': '#C64C53', 'ec': '#674024', 'lw': 0.5, 'zorder': 14},
            'highway': {'fc': '#C64C53', 'ec': '#674024', 'lw': 0.5, 'zorder': 18},
            'motorway': {'fc': '#C64C53', 'ec': '#674024', 'lw': 0.1, 'zorder': 18},
            'primary': {'fc': '#C64C53', 'ec': '#674024', 'lw': 0.1, 'zorder': 17},
            'service': {'fc': '#C64C53', 'ec': '#674024', 'lw': 0.1, 'zorder': 17},
            'trunk': {'fc': '#C64C53', 'ec': '#674024', 'lw': 0.1, 'zorder': 17},
            'secondary': {'fc': '#C64C53', 'ec': '#674024', 'lw': 0.1, 'zorder': 17},
            'tertiary': {'fc': '#C64C53', 'ec': '#674024', 'lw': 0.1, 'zorder': 17},
            'residential': {'fc': '#C64C53', 'ec': '#674024', 'lw': 0.1, 'zorder': 17},
            'living_street': {'fc': '#674024', 'ec': '#F6EBD1', 'lw': 0.1, 'zorder': 17},
            'pedestrian': {'fc': '#674024', 'ec': '#F6EBD1', 'lw': 0.1, 'zorder': 17},
            'footway': {'fc': '#674024', 'ec': '#F6EBD1', 'lw': 0.1, 'zorder': 17},
            'sideway': {'fc': '#674024', 'ec': '#F6EBD1', 'lw': 0.1, 'zorder': 17},
            'track': {'fc': '#674024', 'ec': '#F6EBD1', 'lw': 0.1, 'zorder': 17},
            'bridleway': {'fc': '#674024', 'ec': '#F6EBD1', 'lw': 0.1, 'zorder': 17},
            'cycleway': {'fc': '#674024', 'ec': '#F6EBD1', 'lw': 0.1, 'zorder': 17},
            'path': {'fc': '#674024', 'ec': '#F6EBD1', 'lw': 0.1, 'zorder': 17},
            'coastline': {'fc': '#7DC1A8', 'ec': '#B4D5A8','hatch': '...', 'hatch_c': '#B4D5A8', 'lw': 0, 'zorder': 2}
        },
