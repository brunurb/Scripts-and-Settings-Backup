...
'water': {
    ...
    'tags':{
        ...
        drawing_kwargs = {
            ...
            'perimeter': {'fc': '#2e3561', 'ec': '#ff1f1f', 'lw': 4, 'zorder': 0},
            ...
            'man_made': {'fc': '#2e3561', 'ec': '#ffffff','hatch': 'x', 'hatch_c': '#ffffff',  'lw': 2, 'zorder': 16},
            'garden': {'fc': '#2e3561', 'ec': '#ffffff', 'lw': 1, 'zorder': 1},
            'coastline': {'fc': '#2e3561', 'ec': '#ffffff','hatch': '...', 'hatch_c': '#ffffff', 'lw': 1, 'zorder': 2},
...
plt.savefig('3030BPmapB.png', dpi=200)
plt.savefig('3030BPmapB.svg')
