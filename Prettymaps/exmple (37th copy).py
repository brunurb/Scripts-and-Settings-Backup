...
'water': {
    ...
    'tags':{
        ...
        drawing_kwargs = {
            'background': {'fc': '#081820', 'ec': '#081820', 'zorder': -1},
            'perimeter': {'fc': '#081820', 'ec': '#081820', 'lw': 4, 'zorder': 0},
            'green': {'fc': '#88c070', 'ec': '#e0f8d0', 'lw': 0.5, 'zorder': 1},
            'water': {'fc': '#88c070', 'ec': '#e0f8d0','hatch': '...', 'hatch_c': '#e0f8d0', 'lw': 0, 'zorder': 1},
            'streets': {'fc': '#42143e', 'ec': '#42143e', 'lw': 1, 'zorder': 16},
            'building': {'fc': '#346856', 'ec': '#88C070', 'lw': 0.5, 'zorder': 15},
            'forest': {'fc': '#88c070', 'ec': '#e0f8d0', 'lw': 0.5, 'zorder': 1},
            'agriculture': {'fc': '#88c070', 'ec': '#e0f8d0', 'lw': 0.5, 'zorder': 1},
            'developingLand': {'fc': '#88c070', 'ec': '#e0f8d0', 'lw': 0.5, 'zorder': 8},
            'sportstuff': {'fc': '#88c070', 'ec': '#e0f8d0', 'lw': 0.5, 'zorder': 8},
            'gleisbett': {'fc': '#88c070', 'ec': '#e0f8d0', 'lw': 0.5, 'zorder': 7},
            'cemeterystuff': {'fc': '#88c070', 'ec': '#e0f8d0', 'lw': 0.5, 'zorder': 14},
            'place': {'fc': '#88c070', 'ec': '#e0f8d0', 'lw': 0.1, 'zorder': 6},
            'man_made': {'fc': '#42143e', 'ec': '#be1059', 'lw': 2, 'zorder': 16},
            'garden': {'fc': '#88c070', 'ec': '#e0f8d0', 'lw': 1, 'zorder': 1},
            'railway': {'fc': '#0AFF52', 'ec': '#FF5CFF', 'lw': 0.1, 'zorder': 12},
            'parkplatz': {'fc': '#88c070', 'ec': '#e0f8d0', 'lw': 0.5, 'zorder': 14},
            ...
            'coastline': {'fc': '#346856', 'ec': '#88C070','hatch': '...', 'hatch_c': '#e0f8d0', 'lw': 0, 'zorder': 2}
        },
