...
'water': {
    ...
    'tags':{
        ...
        'dilate':True,
            ...
            'sportstuff': {'circle': False,'tags': { 'leisure': ['track'] }},
            ...
            'stadium': {'circle': False,'tags': {'leisure': ['stadium']}},
            'pitch': {'circle': False,'tags': {'leisure': ['pitch']}},
        },
        ...
        drawing_kwargs = {
            ...
            'pitch': {'fc': '#0c9c11', 'ec': '#065c09', 'lw': 4, 'zorder': 17},
            'sports_centre': {'fc': '#f700ff', 'fill': True, 'alpha':1, 'ec': '#f700ff', 'lw': 4, 'zorder': 19},
            'stadium': {'fc': '#0e4a08', 'ec': '#ffffff','hatch': '//', 'hatch_c': '#ffffff', 'lw': 8, 'zorder': 16}
        },
...
plt.savefig('3030map.png', dpi=200)
plt.savefig('3030map.svg')
