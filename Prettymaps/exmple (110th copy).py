...
layers = plot(
    ...
    layers = {
        ...
        drawing_kwargs = {
            ...
            'green': {'palette': ['#0099e6', '#12255a', '#f23814', '#dfb78b', '#b6c3c5'], 'lw': 1, 'zorder': 1},
            'water': {'fc': '#79a5ec', 'ec': '#94c6ee', 'lw': 0, 'zorder': 9},
            'streets': {'fc': '#f2d8bf', 'lw': 0, 'zorder': 4},
            'building': {'palette': ['#0099e6', '#12255a', '#f23814', '#dfb78b', '#b6c3c5'], 'lw': 0.1, 'zorder': 9},
            ...
            'parkplatz': {'palette': ['#0099e6', '#12255a', '#f23814', '#dfb78b', '#b6c3c5'], 'lw': 0.1, 'zorder': 3},
            'gleisbett': {'palette': ['#0099e6', '#12255a', '#f23814', '#dfb78b', '#b6c3c5'], 'lw': 0, 'zorder': 7},
            'cemeterystuff': {'palette': ['#0099e6', '#12255a', '#f23814', '#dfb78b', '#b6c3c5'], 'lw': 0, 'zorder': 9},
