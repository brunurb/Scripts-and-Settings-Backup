...
layers = plot(
    ...
    layers = {
        ...
        drawing_kwargs = {
            ...
            'green': {'palette': ['#d3f2a3', '#97e196', '#6cc08b', '#4c9b82', '#217a79', '#105965', '#074050'], 'lw': 1, 'zorder': 1},
            'water': {'fc': '#79a5ec', 'ec': '#94c6ee', 'lw': 0, 'zorder': 9},
            'streets': {'fc': '#f2d8bf', 'lw': 0, 'zorder': 4},
            'building': {'palette': ['#d3f2a3', '#97e196', '#6cc08b', '#4c9b82', '#217a79', '#105965', '#074050'], 'lw': 0.1, 'zorder': 9},
            'railway': {'fc': '#a2c2db', 'ec': '#FF0000', 'alpha': 1, 'lw': 0, 'zorder': 8},
            'forest': {'palette': ['#d3f2a3', '#97e196', '#6cc08b', '#4c9b82', '#217a79', '#105965', '#074050'], 'lw': 0, 'zorder': 1},
            'agriculture': {'palette': ['#d3f2a3', '#97e196', '#6cc08b', '#4c9b82', '#217a79', '#105965', '#074050'], 'lw': 0, 'zorder': 1},
            'developingLand': {'palette': ['#d3f2a3', '#97e196', '#6cc08b', '#4c9b82', '#217a79', '#105965', '#074050'], 'lw': 0, 'zorder': 8},
            'sportstuff': {'palette': ['#d3f2a3', '#97e196', '#6cc08b', '#4c9b82', '#217a79', '#105965', '#074050'], 'lw': 0.3, 'zorder': 8},
            'parkplatz': {'palette': ['#d3f2a3', '#97e196', '#6cc08b', '#4c9b82', '#217a79', '#105965', '#074050'], 'lw': 0.1, 'zorder': 3},
            'gleisbett': {'palette': ['#d3f2a3', '#97e196', '#6cc08b', '#4c9b82', '#217a79', '#105965', '#074050'], 'lw': 0, 'zorder': 7},
            'cemeterystuff': {'palette': ['#d3f2a3', '#97e196', '#6cc08b', '#4c9b82', '#217a79', '#105965', '#074050'], 'lw': 0, 'zorder': 9},
            'highway': {'fc': '#46693b', 'ec': '#ffffff', 'lw': 0, 'zorder': 11},
            'place': {'palette': ['#d3f2a3', '#97e196', '#6cc08b', '#4c9b82', '#217a79', '#105965', '#074050'], 'lw': 0, 'zorder': 6},
