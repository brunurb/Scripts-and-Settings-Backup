...
'water': {
    ...
    'tags':{
        ...
        drawing_kwargs = {
            'background': {'fc': '#201533', 'ec': '#252446', 'zorder': -1},
            'perimeter': {'fc': '#201533', 'ec': '#252446', 'lw': 4, 'zorder': 0},
            'green': {'fc': '#1E579C', 'ec': '#0098DB', 'lw': 0.5, 'zorder': 1},
            'water': {'fc': '#0098DB', 'ec': '#0CE6F2','hatch': '...', 'hatch_c': '#0CE6F2', 'lw': 0, 'zorder': 1},
            'streets': {'fc': '#0CE6F2', 'ec': '#FFFFFF', 'lw': 1, 'zorder': 16},
            'building': {'fc': '#1E579C', 'ec': '#0098DB', 'lw': 0.5, 'zorder': 15},
            'forest': {'fc': '#1E579C', 'ec': '#0098DB', 'lw': 0.5, 'zorder': 1},
            'agriculture': {'fc': '#1E579C', 'ec': '#0098DB', 'lw': 0.5, 'zorder': 1},
            'developingLand': {'fc': '#1E579C', 'ec': '#0098DB', 'lw': 0.5, 'zorder': 8},
            'sportstuff': {'fc': '#1E579C', 'ec': '#0098DB', 'lw': 0.5, 'zorder': 8},
            'gleisbett': {'fc': '#1E579C', 'ec': '#0098DB', 'lw': 0.5, 'zorder': 7},
            'cemeterystuff': {'fc': '#1E579C', 'ec': '#0098DB', 'lw': 0.5, 'zorder': 14},
            'place': {'fc': '#1E579C', 'ec': '#0098DB', 'lw': 0.1, 'zorder': 6},
            'man_made': {'fc': '#1E579C', 'ec': '#0098DB', 'lw': 2, 'zorder': 16},
            'garden': {'fc': '#1E579C', 'ec': '#0098DB', 'lw': 1, 'zorder': 1},
            'railway': {'fc': '#1E579C', 'ec': '#0098DB', 'lw': 0.1, 'zorder': 12},
            'parkplatz': {'fc': '#1E579C', 'ec': '#0098DB', 'lw': 0.5, 'zorder': 14},
            'highway': {'fc': '#0CE6F2', 'ec': '#FFFFFF', 'lw': 0.5, 'zorder': 17},
            'motorway': {'fc': '#0CE6F2', 'ec': '#FFFFFF', 'lw': 0.1, 'zorder': 17},
            'primary': {'fc': '#0CE6F2', 'ec': '#FFFFFF', 'lw': 0.1, 'zorder': 17},
            'service': {'fc': '#0CE6F2', 'ec': '#FFFFFF', 'lw': 0.1, 'zorder': 17},
            'trunk': {'fc': '#0CE6F2', 'ec': '#FFFFFF', 'lw': 0.1, 'zorder': 17},
            'secondary': {'fc': '#0CE6F2', 'ec': '#FFFFFF', 'lw': 0.1, 'zorder': 17},
            'tertiary': {'fc': '#0CE6F2', 'ec': '#FFFFFF', 'lw': 0.1, 'zorder': 17},
            'residential': {'fc': '#0CE6F2', 'ec': '#FFFFFF', 'lw': 0.1, 'zorder': 17},
            'living_street': {'fc': '#0CE6F2', 'ec': '#FFFFFF', 'lw': 0.1, 'zorder': 17},
            'pedestrian': {'fc': '#0CE6F2', 'ec': '#FFFFFF', 'lw': 0.1, 'zorder': 17},
            'footway': {'fc': '#0CE6F2', 'ec': '#FFFFFF', 'lw': 0.1, 'zorder': 17},
            'sideway': {'fc': '#0CE6F2', 'ec': '#FFFFFF', 'lw': 0.1, 'zorder': 17},
            'track': {'fc': '#0CE6F2', 'ec': '#FFFFFF', 'lw': 0.1, 'zorder': 17},
            'bridleway': {'fc': '#0CE6F2', 'ec': '#FFFFFF', 'lw': 0.1, 'zorder': 17},
            'cycleway': {'fc': '#0CE6F2', 'ec': '#FFFFFF', 'lw': 0.1, 'zorder': 17},
            'path': {'fc': '#0CE6F2', 'ec': '#FFFFFF', 'lw': 0.1, 'zorder': 17},
            'coastline': {'fc': '#0098DB', 'ec': '#0CE6F2','hatch': '...', 'hatch_c': '#0CE6F2', 'lw': 0, 'zorder': 2}
        },
