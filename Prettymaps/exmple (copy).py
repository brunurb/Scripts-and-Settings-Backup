...
fig, ax = plt.subplots(figsize = (29, 29), constrained_layout = True)
...
ax.text(
    ...
    fontsize=60,
    color='white',
    bbox=dict(facecolor='#2e3561', edgecolor='white', boxstyle='square'),
...
sc.Figure("2792", "2792", 
    ...
    sc.Panel(sc.SVG("MapBLANK.svg").scale(2.9).move(0,0))
    ).save("compose.svg")
SVG('compose.svg')
print("... ...")
