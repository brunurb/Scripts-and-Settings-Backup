...
'water': {
    ...
    'tags':{
        ...
        drawing_kwargs = {
            'background': {'fc': '#272744', 'ec': '#272744', 'zorder': -1},
            'perimeter': {'fc': '#272744', 'ec': '#272744', 'lw': 4, 'zorder': 0},
            'green': {'fc': '#494D7E', 'ec': '#8B6D9C', 'lw': 0.5, 'zorder': 1},
            'water': {'fc': '#494D7E', 'ec': '#8B6D9C','hatch': '...', 'hatch_c': '#8B6D9C', 'lw': 0, 'zorder': 1},
            'streets': {'fc': '#42143e', 'ec': '#42143e', 'lw': 1, 'zorder': 16},
            'building': {'fc': '#C69FA5', 'ec': '#F2D3AB', 'lw': 0.5, 'zorder': 15},
            'forest': {'fc': '#494D7E', 'ec': '#494D7E', 'lw': 0.5, 'zorder': 1},
            'agriculture': {'fc': '#494D7E', 'ec': '#494D7E', 'lw': 0.5, 'zorder': 1},
            'developingLand': {'fc': '#494D7E', 'ec': '#494D7E', 'lw': 0.5, 'zorder': 8},
            'sportstuff': {'fc': '#494D7E', 'ec': '#494D7E', 'lw': 0.5, 'zorder': 8},
            'gleisbett': {'fc': '#494D7E', 'ec': '#494D7E', 'lw': 0.5, 'zorder': 7},
            'cemeterystuff': {'fc': '#494D7E', 'ec': '#494D7E', 'lw': 0.5, 'zorder': 14},
            'place': {'fc': '#494D7E', 'ec': '#494D7E', 'lw': 0.1, 'zorder': 6},
            'man_made': {'fc': '#42143e', 'ec': '#be1059', 'lw': 2, 'zorder': 16},
            'garden': {'fc': '#494D7E', 'ec': '#494D7E', 'lw': 1, 'zorder': 1},
            'railway': {'fc': '#0AFF52', 'ec': '#FF5CFF', 'lw': 0.1, 'zorder': 12},
            'parkplatz': {'fc': '#494D7E', 'ec': '#494D7E', 'lw': 0.5, 'zorder': 14},
            ...
            'coastline': {'fc': '#494D7E', 'ec': '#8B6D9C','hatch': '...', 'hatch_c': '#8B6D9C', 'lw': 0, 'zorder': 2}
        },
