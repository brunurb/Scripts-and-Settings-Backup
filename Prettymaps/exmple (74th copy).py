...
'water': {
    ...
    'tags':{
        ...
        drawing_kwargs = {
            ...
            'water': {'fc': '#3B99B2', 'ec': '#3B99B2', 'lw': 0, 'zorder': 1},
            'streets': {'fc': '#ED4400', 'lw': 0, 'zorder': 16},
            'building': {'palette': ['#E3B508', '#E96F02', '#E19F00'], 'lw': 0, 'zorder': 15},
            'forest': {'palette': ['#97BC9B', '#CCC751'], 'lw': 0, 'zorder': 1},
            ...
            'railway': {'fc': '#ED4400', 'lw': 0, 'zorder': 12},
            'coastline': {'fc': '#6BAFBB', 'ec': '#6BAFBB', 'lw': 0, 'zorder': 2}
        },
