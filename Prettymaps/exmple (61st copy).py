...
'water': {
    ...
    'tags':{
        ...
        drawing_kwargs = {
            'background': {'fc': '#405010', 'ec': '#405010', 'zorder': -1},
            'perimeter': {'fc': '#405010', 'ec': '#405010', 'lw': 4, 'zorder': 0},
            'green': {'fc': '#A0A840', 'ec': '#D0D058', 'lw': 0.5, 'zorder': 1},
            'water': {'fc': '#405010', 'ec': '#D0D058','hatch': '...', 'hatch_c': '#D0D058', 'lw': 0, 'zorder': 1},
            'streets': {'fc': '#D0D058', 'ec': '#D0D058', 'lw': 1, 'zorder': 16},
            'building': {'fc': '#A0A840', 'ec': '#D0D058', 'lw': 0.5, 'zorder': 15},
            'forest': {'fc': '#708028', 'ec': '#A0A840', 'lw': 0.5, 'zorder': 1},
            'agriculture': {'fc': '#708028', 'ec': '#A0A840', 'lw': 0.5, 'zorder': 1},
            'developingLand': {'fc': '#708028', 'ec': '#A0A840', 'lw': 0.5, 'zorder': 8},
            'sportstuff': {'fc': '#708028', 'ec': '#A0A840', 'lw': 0.5, 'zorder': 8},
            'gleisbett': {'fc': '#708028', 'ec': '#A0A840', 'lw': 0.5, 'zorder': 7},
            'cemeterystuff': {'fc': '#708028', 'ec': '#A0A840', 'lw': 0.5, 'zorder': 14},
            'place': {'fc': '#708028', 'ec': '#A0A840', 'lw': 0.1, 'zorder': 6},
            'man_made': {'fc': '#708028', 'ec': '#A0A840', 'lw': 2, 'zorder': 19},
            'garden': {'fc': '#708028', 'ec': '#A0A840', 'lw': 1, 'zorder': 1},
            'railway': {'fc': '#708028', 'ec': '#A0A840', 'lw': 0.1, 'zorder': 12},
            'parkplatz': {'fc': '#708028', 'ec': '#A0A840', 'lw': 0.5, 'zorder': 14},
            'highway': {'fc': '#D0D058', 'ec': '#D0D058', 'lw': 0.5, 'zorder': 17},
            'motorway': {'fc': '#D0D058', 'ec': '#D0D058', 'lw': 0.1, 'zorder': 17},
            'primary': {'fc': '#D0D058', 'ec': '#D0D058', 'lw': 0.1, 'zorder': 16},
            'service': {'fc': '#D0D058', 'ec': '#D0D058', 'lw': 0.1, 'zorder': 16},
            'trunk': {'fc': '#D0D058', 'ec': '#D0D058', 'lw': 0.1, 'zorder': 16},
            'secondary': {'fc': '#D0D058', 'ec': '#D0D058', 'lw': 0.1, 'zorder': 16},
            'tertiary': {'fc': '#D0D058', 'ec': '#D0D058', 'lw': 0.1, 'zorder': 16},
            'residential': {'fc': '#D0D058', 'ec': '#D0D058', 'lw': 0.1, 'zorder': 17},
            'living_street': {'fc': '#D0D058', 'ec': '#D0D058', 'lw': 0.1, 'zorder': 17},
            'pedestrian': {'fc': '#D0D058', 'ec': '#D0D058', 'lw': 0.1, 'zorder': 17},
            'footway': {'fc': '#D0D058', 'ec': '#D0D058', 'lw': 0.1, 'zorder': 17},
            'sideway': {'fc': '#D0D058', 'ec': '#D0D058', 'lw': 0.1, 'zorder': 17},
            'track': {'fc': '#D0D058', 'ec': '#D0D058', 'lw': 0.1, 'zorder': 17},
            'bridleway': {'fc': '#D0D058', 'ec': '#D0D058', 'lw': 0.1, 'zorder': 17},
            'cycleway': {'fc': '#D0D058', 'ec': '#D0D058', 'lw': 0.1, 'zorder': 17},
            'path': {'fc': '#D0D058', 'ec': '#D0D058', 'lw': 0.1, 'zorder': 17},
            'coastline': {'fc': '#405010', 'ec': '#D0D058','hatch': '...', 'hatch_c': '#D0D058', 'lw': 0, 'zorder': 2}
        },
