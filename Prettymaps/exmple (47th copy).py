...
'water': {
    ...
    'tags':{
        ...
        drawing_kwargs = {
            ...
            'streets': {'fc': '#731572', 'ec': '#731572', 'lw': 1, 'zorder': 16},
            ...
            'railway': {'fc': '#FFA81A', 'ec': '#731572', 'lw': 0.1, 'zorder': 12},
            'parkplatz': {'fc': '#731572', 'ec': '#00FFE8', 'lw': 0.5, 'zorder': 14},
            'highway': {'fc': '#C00050', 'ec': '#731572', 'lw': 0.5, 'zorder': 18},
            'motorway': {'fc': '#FF2636', 'ec': '#731572', 'lw': 0.1, 'zorder': 18},
            'primary': {'fc': '#ffa81a', 'ec': '#731572', 'lw': 0.1, 'zorder': 17},
            'service': {'fc': '#4064AF', 'ec': '#731572', 'lw': 0.1, 'zorder': 17},
            'trunk': {'fc': '#FFA81A', 'ec': '#731572', 'lw': 0.1, 'zorder': 17},
            'secondary': {'fc': '#FF2636', 'ec': '#731572', 'lw': 0.1, 'zorder': 17},
            'tertiary': {'fc': '#C00050', 'ec': '#731572', 'lw': 0.1, 'zorder': 17},
            'residential': {'fc': '#FF2636', 'ec': '#731572', 'lw': 0.1, 'zorder': 17},
            'living_street': {'fc': '#FFA81A', 'ec': '#731572', 'lw': 0.1, 'zorder': 17},
            'pedestrian': {'fc': '#C00050', 'ec': '#731572', 'lw': 0.1, 'zorder': 17},
            'footway': {'fc': '#4064af', 'ec': '#731572', 'lw': 0.1, 'zorder': 17},
            'sideway': {'fc': '#4064af', 'ec': '#731572', 'lw': 0.1, 'zorder': 17},
            'track': {'fc': '#FF2636', 'ec': '#731572', 'lw': 0.1, 'zorder': 17},
            'bridleway': {'fc': '#C00050', 'ec': '#731572', 'lw': 0.1, 'zorder': 17},
            'cycleway': {'fc': '#FFA81A', 'ec': '#731572', 'lw': 0.1, 'zorder': 17},
            'path': {'fc': '#4064AF', 'ec': '#731572', 'lw': 0.1, 'zorder': 17},
