...
'water': {
    ...
    'tags':{
        ...
        drawing_kwargs = {
            'background': {'fc': '#01051c', 'ec': '#df9ff5', 'zorder': -1},
            'perimeter': {'fc': '#01051c', 'ec': '#df9ff5', 'lw': 0, 'zorder': 0},
            'green': {'fc': '#01051c', 'ec': '#df9ff5', 'lw': 0.5, 'zorder': 1},
            'water': {'fc': '#01051c', 'ec': '#01051c','hatch': '...', 'hatch_c': '#01318a', 'lw': 0, 'zorder': 1},
            'streets': {'fc': '#01051c', 'ec': '#fffd01', 'lw': 0.1, 'zorder': 12},
            'building': {'fc': '#010f29', 'ec': '#012363', 'lw': 2, 'zorder': 18},
            'railway': {'fc': '#01051c', 'ec': '#df9ff5', 'lw': 0.1, 'zorder': 12},
            'forest': {'fc': '#01051c', 'ec': '#df9ff5', 'lw': 0.5, 'zorder': 1},
            'agriculture': {'fc': '#01051c', 'ec': '#df9ff5', 'lw': 0.5, 'zorder': 1},
            'developingLand': {'fc': '#01051c', 'ec': '#df9ff5', 'lw': 0.5, 'zorder': 8},
            'sportstuff': {'fc': '#01051c', 'ec': '#df9ff5', 'lw': 0.5, 'zorder': 8},
            'parkplatz': {'fc': '#01051c', 'ec': '#df9ff5', 'lw': 0.5, 'zorder': 3},
            'gleisbett': {'fc': '#01051c', 'ec': '#df9ff5', 'lw': 0.5, 'zorder': 7},
            'cemeterystuff': {'fc': '#01051c', 'ec': '#df9ff5', 'lw': 0.5, 'zorder': 14},
            'highway': {'fc': '#01051c', 'ec': '#e359ff', 'lw': 0.5, 'zorder': 17},
            'place': {'fc': '#01051c', 'ec': '#99ff00', 'lw': 0.1, 'zorder': 6},
            'man_made': {'fc': '#01051c', 'ec': '#fffd01', 'lw': 0.2, 'zorder': 18},
            'garden': {'fc': '#01051c', 'ec': '#df9ff5', 'lw': 0.1, 'zorder': 1},
            'coastline': {'fc': '#01051c', 'ec': '#01051c','hatch': '...', 'hatch_c': '#01318a', 'lw': 0, 'zorder': 2},
            ...
            'pedestrian': {'fc': '#01051c', 'ec': '#FFFD01', 'lw': 0.1, 'zorder': 17},
            'footway': {'fc': '#FF015B', 'ec': '#051885', 'lw': 0.1, 'zorder': 17},
...
mplcyberpunk.make_lines_glow(layers)
