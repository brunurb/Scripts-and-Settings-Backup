...
fig, ax = plt.subplots(figsize = (30, 30), constrained_layout = False)
#fig, ax = plt.subplots(figsize = (30, 30), constrained_layout = True)
...
'water': {
    ...
    'tags':{
        ...
        drawing_kwargs = {
            ...
            'perimeter': {'fc': '#2b190b', 'ec': '#000000', 'lw': 0, 'zorder': 0},
            'green': {'fc': '#5dab4d', 'ec': '#89fa73', 'lw': 0.5, 'zorder': 1},
            'water': {'fc': '#79a5ec', 'ec': '#94c6ee', 'lw': 0, 'zorder': 1},
            'streets': {'fc': '#161a24', 'ec': '#ffffff', 'lw': 1, 'zorder': 12},
            'building': {'palette': ['#f58877', '#b35344', '#e37242', '#bd5022'], 'lw': 0.1, 'zorder': 15},
            'railway': {'fc': '#a2c2db', 'ec': '#7a8a57', 'lw': 0.1, 'zorder': 12},
            ...
            'sportstuff': {'fc': '#50bf0f', 'ec': '#ffffff', 'lw': 0.5, 'zorder': 8},
            'parkplatz': {'fc': '#42423a', 'ec': '#ffffff', 'lw': 0.5, 'zorder': 3},
            'gleisbett': {'fc': '#7a7649', 'ec': '#ffffff', 'lw': 0.5, 'zorder': 7},
            'cemeterystuff': {'fc': '#7BAE82', 'ec': '#2F3737', 'lw': 0.5, 'zorder': 14},
            'highway': {'fc': '#46693b', 'ec': '#ffffff', 'lw': 0.5, 'zorder': 10},
            'place': {'fc': '#819c78', 'ec': '#ffffff', 'lw': 0.1, 'zorder': 16},
            'man_made': {'fc': '#b52812', 'ec': '#ffffff','hatch': 'x', 'hatch_c': '#ffffff',  'lw': 2, 'zorder': 16},
            'garden': {'fc': '#5dab4d', 'ec': '#ffffff', 'lw': 1, 'zorder': 1},
            'coastline': {'fc': '#4d58a1', 'ec': '#ffffff','hatch': '...', 'hatch_c': '#ffffff', 'lw': 1, 'zorder': 2},
            'highway': {'fc': '#ffffff', 'ec': '#ffffff', 'lw': 4, 'zorder': 17}
        },
...
plt.savefig('3030COLORmapB.png', dpi=200)
plt.savefig('3030COLORmapB.svg')
