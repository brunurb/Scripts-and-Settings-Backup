...
'water': {
    ...
    'tags':{
        ...
        drawing_kwargs = {
            ...
            'water': {'fc': '#ed5189', 'ec': '#e38fad','hatch': '...', 'hatch_c': '#e38fad', 'lw': 0, 'zorder': 1},
            'streets': {'fc': '#5c3175', 'ec': '#2e215e', 'lw': 1, 'zorder': 16},
            ...
            'man_made': {'fc': '#731572', 'ec': '#731572', 'lw': 2, 'zorder': 19},
            'garden': {'fc': '#7C183C', 'ec': '#7C183C', 'lw': 1, 'zorder': 1},
            'railway': {'fc': '#d9ff00', 'ec': '#15b383', 'lw': 0.1, 'zorder': 12},
            'parkplatz': {'fc': '#731572', 'ec': '#00FFE8', 'lw': 0.5, 'zorder': 14},
            'highway': {'palette': ['#ffd000', '#ff0084', '#ff0040', '#4c00ff'], 'lw': 1, 'zorder': 18},
            'motorway': {'palette': ['#ffd000', '#ff0084', '#ff0040', '#4c00ff'], 'lw': 1, 'zorder': 18},
            'primary': {'palette': ['#ffd000', '#ff0084', '#ff0040', '#4c00ff'], 'lw': 0.1, 'zorder': 16},
            'service': {'palette': ['#ffd000', '#ff0084', '#ff0040', '#4c00ff'], 'lw': 0.1, 'zorder': 16},
            'trunk': {'palette': ['#ffd000', '#ff0084', '#ff0040', '#4c00ff'], 'lw': 0.1, 'zorder': 16},
            'secondary': {'palette': ['#ffd000', '#ff0084', '#ff0040', '#4c00ff'], 'lw': 0.1, 'zorder': 16},
            'tertiary': {'palette': ['#ffd000', '#ff0084', '#ff0040', '#4c00ff'], 'lw': 0.1, 'zorder': 16},
            'residential': {'palette': ['#ffd000', '#ff0084', '#ff0040', '#4c00ff'], 'lw': 0.1, 'zorder': 17},
            'living_street': {'palette': ['#ffd000', '#ff0084', '#ff0040', '#4c00ff'], 'lw': 0.1, 'zorder': 17},
            'pedestrian': {'palette': ['#ffd000', '#ff0084', '#ff0040', '#4c00ff'], 'lw': 0.1, 'zorder': 17},
            'footway': {'palette': ['#ffd000', '#ff0084', '#ff0040', '#4c00ff'], 'lw': 0.1, 'zorder': 17},
            'sideway': {'palette': ['#ffd000', '#ff0084', '#ff0040', '#4c00ff'], 'lw': 0.1, 'zorder': 17},
            'track': {'palette': ['#ffd000', '#ff0084', '#ff0040', '#4c00ff'], 'lw': 0.1, 'zorder': 17},
            'bridleway': {'palette': ['#ffd000', '#ff0084', '#ff0040', '#4c00ff'], 'lw': 0.1, 'zorder': 17},
            'cycleway': {'palette': ['#ffd000', '#ff0084', '#ff0040', '#4c00ff'], 'lw': 0.1, 'zorder': 17},
            'path': {'palette': ['#ffd000', '#ff0084', '#ff0040', '#4c00ff'], 'lw': 0.1, 'zorder': 17},
            'coastline': {'fc': '#ed5189', 'ec': '#e38fad','hatch': '...', 'hatch_c': '#e38fad', 'lw': 0, 'zorder': 2}
        },
