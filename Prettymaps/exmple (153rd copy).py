...
'water': {
    ...
    'tags':{
        ...
        drawing_kwargs = {
            'background': {'fc': '#2d4a80', 'ec': '#ffffff', 'zorder': -1},
            'perimeter': {'fc': '#2d4a80', 'ec': '#ffffff', 'lw': 4, 'zorder': 0},
            'green': {'fc': '#2d4a80', 'ec': '#ffffff', 'lw': 0.5, 'zorder': 1},
            'water': {'fc': '#2d4a80', 'ec': '#ffffff','hatch': '...', 'hatch_c': '#ffffff', 'lw': 0, 'zorder': 1},
            'streets': {'fc': '#2d4a80', 'ec': '#ffffff', 'lw': 1, 'zorder': 12},
            'building': {'fc': '#2d4a80', 'ec': '#ffffff', 'lw': 0.5, 'zorder': 15},
            'railway': {'fc': '#2d4a80', 'ec': '#ffffff', 'lw': 0.1, 'zorder': 12},
            'forest': {'fc': '#2d4a80', 'ec': '#ffffff', 'lw': 0.5, 'zorder': 1},
            'agriculture': {'fc': '#2d4a80', 'ec': '#ffffff', 'lw': 0.5, 'zorder': 1},
            'developingLand': {'fc': '#2d4a80', 'ec': '#ffffff', 'lw': 0.5, 'zorder': 8},
            'sportstuff': {'fc': '#2d4a80', 'ec': '#ffffff', 'lw': 0.5, 'zorder': 8},
            'parkplatz': {'fc': '#2d4a80', 'ec': '#ffffff', 'lw': 0.5, 'zorder': 3},
            'gleisbett': {'fc': '#2d4a80', 'ec': '#ffffff', 'lw': 0.5, 'zorder': 7},
            'cemeterystuff': {'fc': '#2d4a80', 'ec': '#ffffff', 'lw': 0.5, 'zorder': 14},
            'highway': {'fc': '#2d4a80', 'ec': '#ffffff', 'lw': 0.5, 'zorder': 10},
            'place': {'fc': '#2d4a80', 'ec': '#ffffff', 'lw': 0.1, 'zorder': 6},
            'man_made': {'fc': '#2d4a80', 'ec': '#ffffff', 'lw': 2, 'zorder': 16},
            'garden': {'fc': '#2d4a80', 'ec': '#ffffff', 'lw': 1, 'zorder': 1},
            'coastline': {'fc': '#2d4a80', 'ec': '#ffffff','hatch': '...', 'hatch_c': '#ffffff', 'lw': 0, 'zorder': 2},
            'highway': {'fc': '#ffe70a', 'ec': '#ff1f1f', 'lw': 4, 'zorder': 17}
        },
