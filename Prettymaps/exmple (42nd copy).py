...
'water': {
    ...
    'tags':{
        ...
        drawing_kwargs = {
            'background': {'fc': '#002859', 'ec': '#002859', 'zorder': -1},
            'perimeter': {'fc': '#002859', 'ec': '#002859', 'lw': 4, 'zorder': 0},
            'green': {'fc': '#234975', 'ec': '#234975', 'lw': 0.5, 'zorder': 1},
            'water': {'fc': '#68AED4', 'ec': '#007899','hatch': '...', 'hatch_c': '#007899', 'lw': 0, 'zorder': 1},
            'streets': {'fc': '#FFD100', 'ec': '#430067', 'lw': 1, 'zorder': 16},
            'building': {'fc': '#234975', 'ec': '#002859', 'lw': 0.5, 'zorder': 15},
            'forest': {'fc': '#234975', 'ec': '#234975', 'lw': 0.5, 'zorder': 1},
            'agriculture': {'fc': '#234975', 'ec': '#234975', 'lw': 0.5, 'zorder': 1},
            'developingLand': {'fc': '#234975', 'ec': '#234975', 'lw': 0.5, 'zorder': 8},
            'sportstuff': {'fc': '#234975', 'ec': '#234975', 'lw': 0.5, 'zorder': 8},
            'gleisbett': {'fc': '#234975', 'ec': '#234975', 'lw': 0.5, 'zorder': 7},
            'cemeterystuff': {'fc': '#234975', 'ec': '#234975', 'lw': 0.5, 'zorder': 14},
            'place': {'fc': '#234975', 'ec': '#234975', 'lw': 0.1, 'zorder': 6},
            'man_made': {'fc': '#234975', 'ec': '#234975', 'lw': 2, 'zorder': 16},
            'garden': {'fc': '#234975', 'ec': '#234975', 'lw': 1, 'zorder': 1},
            'railway': {'fc': '#FF8426', 'ec': '#430067', 'lw': 0.1, 'zorder': 12},
            'parkplatz': {'fc': '#FAFDFF', 'ec': '#EE8695', 'lw': 0.5, 'zorder': 14},
            'highway': {'fc': '#FF2674', 'ec': '#430067', 'lw': 0.5, 'zorder': 17},
            'motorway': {'fc': '#FF80A4', 'ec': '#430067', 'lw': 0.1, 'zorder': 17},
            'primary': {'fc': '#BFFF3C', 'ec': '#430067', 'lw': 0.1, 'zorder': 17},
            'service': {'fc': '#10D275', 'ec': '#430067', 'lw': 0.1, 'zorder': 17},
            'trunk': {'fc': '#D62411', 'ec': '#430067', 'lw': 0.1, 'zorder': 17},
            'secondary': {'fc': '#94216A', 'ec': '#430067', 'lw': 0.1, 'zorder': 17},
            'tertiary': {'fc': '#BFFF3C', 'ec': '#430067', 'lw': 0.1, 'zorder': 17},
            'residential': {'fc': '#FFD100', 'ec': '#430067', 'lw': 0.1, 'zorder': 17},
            'living_street': {'fc': '#FF8426', 'ec': '#430067', 'lw': 0.1, 'zorder': 17},
            'pedestrian': {'fc': '#FF2674', 'ec': '#430067', 'lw': 0.1, 'zorder': 17},
            'footway': {'fc': '#FAFDFF', 'ec': '#430067', 'lw': 0.1, 'zorder': 17},
            'sideway': {'fc': '#10D275', 'ec': '#430067', 'lw': 0.1, 'zorder': 17},
            'track': {'fc': '#FFD100', 'ec': '#430067', 'lw': 0.1, 'zorder': 17},
            'bridleway': {'fc': '#68AED4', 'ec': '#430067', 'lw': 0.1, 'zorder': 17},
            'cycleway': {'fc': '#FF8426', 'ec': '#430067', 'lw': 0.1, 'zorder': 17},
            'path': {'fc': '#FF80A4', 'ec': '#430067', 'lw': 0.1, 'zorder': 17},
            'coastline': {'fc': '#68AED4', 'ec': '#007899','hatch': '...', 'hatch_c': '#007899', 'lw': 0, 'zorder': 2}
        },
