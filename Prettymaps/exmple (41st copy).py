...
'water': {
    ...
    'tags':{
        ...
        drawing_kwargs = {
            'background': {'fc': '#292831', 'ec': '#292831', 'zorder': -1},
            'perimeter': {'fc': '#292831', 'ec': '#292831', 'lw': 4, 'zorder': 0},
            'green': {'fc': '#333F58', 'ec': '#333F58', 'lw': 0.5, 'zorder': 1},
            'water': {'fc': '#333F58', 'ec': '#4A7A96','hatch': '...', 'hatch_c': '#4A7A96', 'lw': 0, 'zorder': 1},
            'streets': {'fc': '#EE8695', 'ec': '#292831', 'lw': 1, 'zorder': 16},
            'building': {'fc': '#FBBBAD', 'ec': '#292831', 'lw': 0.5, 'zorder': 15},
            'forest': {'fc': '#333F58', 'ec': '#333F58', 'lw': 0.5, 'zorder': 1},
            'agriculture': {'fc': '#333F58', 'ec': '#333F58', 'lw': 0.5, 'zorder': 1},
            'developingLand': {'fc': '#333F58', 'ec': '#333F58', 'lw': 0.5, 'zorder': 8},
            'sportstuff': {'fc': '#333F58', 'ec': '#333F58', 'lw': 0.5, 'zorder': 8},
            'gleisbett': {'fc': '#333F58', 'ec': '#333F58', 'lw': 0.5, 'zorder': 7},
            'cemeterystuff': {'fc': '#333F58', 'ec': '#333F58', 'lw': 0.5, 'zorder': 14},
            'place': {'fc': '#333F58', 'ec': '#333F58', 'lw': 0.1, 'zorder': 6},
            'man_made': {'fc': '#333F58', 'ec': '#333F58', 'lw': 2, 'zorder': 16},
            'garden': {'fc': '#333F58', 'ec': '#333F58', 'lw': 1, 'zorder': 1},
            'railway': {'fc': '#EE8695', 'ec': '#292831', 'lw': 0.1, 'zorder': 12},
            'parkplatz': {'fc': '#292831', 'ec': '#EE8695', 'lw': 0.5, 'zorder': 14},
            'highway': {'fc': '#EE8695', 'ec': '#292831', 'lw': 0.5, 'zorder': 17},
            'motorway': {'fc': '#EE8695', 'ec': '#292831', 'lw': 0.1, 'zorder': 17},
            'primary': {'fc': '#EE8695', 'ec': '#292831', 'lw': 0.1, 'zorder': 17},
            'service': {'fc': '#EE8695', 'ec': '#292831', 'lw': 0.1, 'zorder': 17},
            'trunk': {'fc': '#EE8695', 'ec': '#292831', 'lw': 0.1, 'zorder': 17},
            'secondary': {'fc': '#EE8695', 'ec': '#292831', 'lw': 0.1, 'zorder': 17},
            'tertiary': {'fc': '#EE8695', 'ec': '#292831', 'lw': 0.1, 'zorder': 17},
            'residential': {'fc': '#EE8695', 'ec': '#292831', 'lw': 0.1, 'zorder': 17},
            'living_street': {'fc': '#EE8695', 'ec': '#292831', 'lw': 0.1, 'zorder': 17},
            'pedestrian': {'fc': '#EE8695', 'ec': '#292831', 'lw': 0.1, 'zorder': 17},
            'footway': {'fc': '#EE8695', 'ec': '#292831', 'lw': 0.1, 'zorder': 17},
            'sideway': {'fc': '#EE8695', 'ec': '#292831', 'lw': 0.1, 'zorder': 17},
            'track': {'fc': '#EE8695', 'ec': '#292831', 'lw': 0.1, 'zorder': 17},
            'bridleway': {'fc': '#EE8695', 'ec': '#292831', 'lw': 0.1, 'zorder': 17},
            'cycleway': {'fc': '#EE8695', 'ec': '#292831', 'lw': 0.1, 'zorder': 17},
            'path': {'fc': '#EE8695', 'ec': '#292831', 'lw': 0.1, 'zorder': 17},
            'coastline': {'fc': '#333F58', 'ec': '#4A7A96','hatch': '...', 'hatch_c': '#4A7A96', 'lw': 0, 'zorder': 2}
        },
