...
'water': {
    ...
    'tags':{
        ...
        drawing_kwargs = {
            ...
            'primary': {'fc': '#53EBE4', 'ec': '#4D004F', 'lw': 0.1, 'zorder': 17},
            'service': {'fc': '#53EBE4', 'ec': '#4D004F', 'lw': 0.1, 'zorder': 17},
            'trunk': {'fc': '#53EBE4', 'ec': '#4D004F', 'lw': 0.1, 'zorder': 17},
            'secondary': {'fc': '#53EBE4', 'ec': '#4D004F', 'lw': 0.1, 'zorder': 17},
            'tertiary': {'fc': '#53EBE4', 'ec': '#4D004F', 'lw': 0.1, 'zorder': 17},
