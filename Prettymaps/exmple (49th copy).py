...
'water': {
    ...
    'tags':{
        ...
        drawing_kwargs = {
            'background': {'fc': '#074050', 'ec': '#074050', 'zorder': -1},
            'perimeter': {'fc': '#074050', 'ec': '#074050', 'lw': 4, 'zorder': 0},
            'green': {'fc': '#6CC08B', 'ec': '#074050', 'lw': 0.5, 'zorder': 1},
            'water': {'fc': '#217A79', 'ec': '#074050','hatch': '...', 'hatch_c': '#074050', 'lw': 0, 'zorder': 1},
            'streets': {'fc': '#074050', 'ec': '#D3F2A3', 'lw': 1, 'zorder': 16},
            'building': {'fc': '#105965', 'ec': '#074050', 'lw': 0.5, 'zorder': 15},
            'forest': {'fc': '#6CC08B', 'ec': '#074050', 'lw': 0.5, 'zorder': 1},
            'agriculture': {'fc': '#97E196', 'ec': '#074050', 'lw': 0.5, 'zorder': 1},
            'developingLand': {'fc': '#6CC08B', 'ec': '#074050', 'lw': 0.5, 'zorder': 8},
            'sportstuff': {'fc': '#97E196', 'ec': '#074050', 'lw': 0.5, 'zorder': 8},
            'gleisbett': {'fc': '#074050', 'ec': '#D3F2A3', 'lw': 0.5, 'zorder': 7},
            'cemeterystuff': {'fc': '#97E196', 'ec': '#074050', 'lw': 0.5, 'zorder': 14},
            'place': {'fc': '#6CC08B', 'ec': '#074050', 'lw': 0.1, 'zorder': 6},
            'man_made': {'fc': '#074050', 'ec': '#D3F2A3', 'lw': 2, 'zorder': 19},
            'garden': {'fc': '#6CC08B', 'ec': '#074050', 'lw': 1, 'zorder': 1},
            'railway': {'fc': '#074050', 'ec': '#D3F2A3', 'lw': 0.1, 'zorder': 12},
            'parkplatz': {'fc': '#074050', 'ec': '#D3F2A3', 'lw': 0.5, 'zorder': 14},
            'highway': {'fc': '#074050', 'ec': '#D3F2A3', 'lw': 0.5, 'zorder': 18},
            'motorway': {'fc': '#074050', 'ec': '#D3F2A3', 'lw': 0.1, 'zorder': 18},
            'primary': {'fc': '#074050', 'ec': '#D3F2A3', 'lw': 0.1, 'zorder': 17},
            'service': {'fc': '#074050', 'ec': '#D3F2A3', 'lw': 0.1, 'zorder': 17},
            'trunk': {'fc': '#074050', 'ec': '#D3F2A3', 'lw': 0.1, 'zorder': 17},
            'secondary': {'fc': '#074050', 'ec': '#D3F2A3', 'lw': 0.1, 'zorder': 17},
            'tertiary': {'fc': '#074050', 'ec': '#D3F2A3', 'lw': 0.1, 'zorder': 17},
            'residential': {'fc': '#074050', 'ec': '#D3F2A3', 'lw': 0.1, 'zorder': 17},
            'living_street': {'fc': '#074050', 'ec': '#D3F2A3', 'lw': 0.1, 'zorder': 17},
            'pedestrian': {'fc': '#074050', 'ec': '#D3F2A3', 'lw': 0.1, 'zorder': 17},
            'footway': {'fc': '#074050', 'ec': '#D3F2A3', 'lw': 0.1, 'zorder': 17},
            'sideway': {'fc': '#074050', 'ec': '#D3F2A3', 'lw': 0.1, 'zorder': 17},
            'track': {'fc': '#074050', 'ec': '#D3F2A3', 'lw': 0.1, 'zorder': 17},
            'bridleway': {'fc': '#074050', 'ec': '#D3F2A3', 'lw': 0.1, 'zorder': 17},
            'cycleway': {'fc': '#074050', 'ec': '#D3F2A3', 'lw': 0.1, 'zorder': 17},
            'path': {'fc': '#074050', 'ec': '#D3F2A3', 'lw': 0.1, 'zorder': 17},
            'coastline': {'fc': '#217A79', 'ec': '#074050','hatch': '...', 'hatch_c': '#074050', 'lw': 0, 'zorder': 2}
        },
