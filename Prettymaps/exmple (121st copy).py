...
# List adjacent plots
places = {
    'Santa Maria Maior, Lisboa, Portugal':['#BA2D0B', '#D5F2E3', '#73BA9B', '#F79D5C'],
    'Graça, Lisboa, Portugal': ['#49392C', '#77625C', '#B2B1CF', '#E1F2FE', '#98D2EB'],
    'Misericórdia, Lisboa, Portugal': ['#433633', '#FF5E5B', '#EEE4E1'],
